...
# Api
java_import 'shibascripts.rubycore.api.RubyCoreApi'
# Minecraft imports
...
java_import 'net.minecraft.item.ItemGroup'
java_import 'net.minecraft.block.Blocks'
java_import 'net.minecraft.client.Minecraft'
java_import 'net.minecraft.item.Items'
java_import 'net.minecraft.item.ItemStack'
java_import 'net.minecraft.item.Item'
java_import 'net.minecraft.item.BlockItem'
java_import 'net.minecraft.world.World'
java_import 'net.minecraft.block.AbstractBlock'
